    ...
    <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-8 items-center px-6">
      ...
      <div className="text-right">
        ...
        <p className="text-slate-400 leading-relaxed mb-4">
          I am a Full Stack Developer currently engineering the Fusion ERP System 
          which serves over 6000 users. My expertise lies in modernizing legacy architectures, 
