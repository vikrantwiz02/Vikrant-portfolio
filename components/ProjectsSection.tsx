...
const LivePreviewModal = ({ project, onClose }: { project: Project | null, onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-[15000] flex items-center justify-center p-4 md:p-10 bg-black/90 backdrop-blur-md">
        ...
        <div className="flex-1 relative bg-white">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-slate-900 -z-10 bg-slate-100">
            ...
            <p className="text-sm mt-2 max-w-md text-center text-slate-500">
              If blank, the server may have blocked embedding.
            </p>
  ...
  return (
    <div
      ...
      className={`transform transition-all duration-700 ease-out ${
        activeSection ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
      }`}
        ...
        <div className="h-full flex flex-col group relative">
          ...
          <div className="h-64 w-full relative overflow-hidden bg-slate-900 border-b border-cyan-500/20 group-hover:border-cyan-400/50 transition-colors pointer-events-none">
            {IS_MOBILE ? (
              ...
              <>
                {/* Loading spinner shown until iframe mounts */}
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 bg-slate-900 pointer-events-none">
  ...
  return (
    <section className="min-h-screen flex flex-col items-center py-24 relative z-10 section-gradient">
      ...
      <div className="flex items-center gap-4 mb-16">
        <div className={`h-[1px] w-12 bg-gradient-to-r from-transparent to-cyan-500/50 transition-all duration-700 ${active ? 'w-20' : 'w-12'}`} />
        ...
        <div className={`h-[1px] w-12 bg-gradient-to-l from-transparent to-cyan-500/50 transition-all duration-700 ${active ? 'w-20' : 'w-12'}`} />
      </div>
